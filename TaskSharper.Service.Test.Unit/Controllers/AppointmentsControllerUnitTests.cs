...
namespace TaskSharper.Service.Test.Unit.Controllers
{
    public class AppointmentsControllerUnitTests
    {
        ...
        private AppointmentsController _uut;
        ...
        public void Setup()
        {
            ...
            _uut = new AppointmentsController(_eventManager, _logger);
        }
        ...
        [Test]
        public async Task GetWithBetweenDates_ValidTimeSpanReturnsAListOfMultipleDifferentEventTypesWhereOnly2IsOfTypeAppointment_ReturnListWith2Events()
        {
